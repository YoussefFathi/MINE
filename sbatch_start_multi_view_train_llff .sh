...
#SBATCH --time=0-06:00
#SBATCH --output=/project/def-karray/yafathi/MINE/sbatch_output/LLFF_MV_2_Res18_MINE_%N-%j.out
...
# nvidia-smi
sh start_multiview_training.sh MASTER_ADDR=$(hostname) MASTER_PORT=1234 N_NODES=1 GPUS_PER_NODE=4 NODE_RANK=0 WORKSPACE=/project/def-karray/yafathi/MINE/ DATASET=llff VERSION=experiments EXTRA_CONFIG='{"training.gpus": "0,1,2,3"}'
